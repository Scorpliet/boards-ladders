...
const EmailConfirmation = () => {
  ...
  return (
    <div style={{overflowY:"hidden"}}>
      <Header start={true} logo2={true} bar={true}></Header>
      <h1 className="page-4">
      ...
      style={{marginTop:"150px"}}
        ...
        <defs><linearGradient
            ...
            <stop stop-color="#222771" />
            <stop offset="1" stop-color="#222771" stop-opacity="0" /></linearGradient>
          <linearGradient
            ...
            x2="212"
            y2="94"
            gradientUnits="userSpaceOnUse"><stop stop-color="#C33764" stop-opacity="0" /><stop offset="1" stop-color="#C33764" />
          </linearGradient></defs>
      </svg>
    </div>
  );
